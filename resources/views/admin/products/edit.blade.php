                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-12 md:col-span-6">
                                    ...
                                    <textarea id="description" name="description" rows="3" class="@error('description') border-red-300 @else border-gray-300 @enderror shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm rounded-md">{{$product->description}}</textarea>
                                    @error('description')
                                        <span class="flex items-center font-medium tracking-wide text-red-500 text-xs mt-1 ml-1">
                                            {{$message}}
                                        </span>
                                ...
                                <div class="col-span-12 md:col-span-6">
                                    ...
                                    <textarea id="body" name="body" rows="3" class="@error('body') border-red-300 @else border-gray-300 @enderror shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm rounded-md">{{$product->body}}</textarea>
                                    @error('body')
                                        <span class="flex items-center font-medium tracking-wide text-red-500 text-xs mt-1 ml-1">
                                            {{$message}}
                                        </span>
                                ...
                                <div class="col-span-12 md:col-span-3">
                                    ...
                                    <input id="price" name="price" type="text" value="{{str_replace('.', ',', $product->price)}}"
